'''Your code will take as input a grayscale image im (a np.ndarray with dtype np.uint8 and shape (3, H, W)) and an integer nbin. It should compute a normalized color histogram of the image, quantized with nbin bins on each color plane.
