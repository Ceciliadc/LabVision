'''Given an input grayscale image im (a np.ndarray with shape (H, W) and dtype np.uint8), write a code which performs a binary thresholding of the image at cut value val, and stores the result in out.
